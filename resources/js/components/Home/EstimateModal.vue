      ...
      <div v-if="isOpen" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div class="modal-header-color text-white px-6 py-4 flex justify-between items-center">
            <h3 class="text-xl fw-bold font-bold">Request Project Estimate</h3>
          ...
          <div class="p-6 overflow-y-auto flex-1">
            <div v-if="!submitted">
              ...
              <div v-else>
                <!-- Services Selection -->
                <div class="mb-4">
                  <h4 class="text-lg font-semibold mb-2 text-gray-800">Select Services You're Interested In</h4>
                  <p class="text-sm text-gray-600 mb-3">Choose the services you'd like us to include in your custom estimate.</p>
                ...
                <div class="bg-blue-50 p-3 rounded-lg mb-4">
                  <div class="flex items-center mb-2">
                    ...
                    <span class="font-medium text-blue-800">About Your Estimate</span>
                  </div>
                  <p class="text-sm text-blue-700">
                    We'll review your selected services and send you a detailed, personalized quote via email within 24 hours.
                  </p>
                </div>

                <!-- Contact Info -->
                <div class="mb-4">
                  <h4 class="text-lg font-semibold mb-2 text-gray-800">Your Contact Details</h4>
                  <div class="space-y-3">
                    <div>
            ...
            <div v-else class="text-center py-6">
              ...
              <div v-else>
                <p class="text-gray-600 mb-6">
                  Thank you! We've received your estimate request and will send you a detailed quote at <strong>{{ email }}</strong> within 24 hours.
                </p>
              </div>
