...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-5xl mx-auto mt-8 px-0" }, _attrs))} data-v-e6089bcd><div class="relative" data-v-e6089bcd><img${ssrRenderAttr("src", images.value[activeIndex.value])} class="w-full h-96 object-cover rounded-lg" alt="Website screenshot" data-v-e6089bcd><button class="absolute top-1/2 left-2 transform -translate-y-1/2 bg-white p-2 rounded shadow" data-v-e6089bcd> ‹ </button><button class="absolute top-1/2 right-2 transform -translate-y-1/2 bg-white p-2 rounded shadow" data-v-e6089bcd> › </button></div><div class="overflow-x-auto mt-4" data-v-e6089bcd><div class="flex gap-2 justify-center min-w-max px-2" data-v-e6089bcd><!--[-->`);
      ssrRenderList(images.value, (img, index) => {
        ...
        }, "w-20 h-12 sm:w-24 sm:h-16 object-cover rounded cursor-pointer border-2 flex-shrink-0"])}" data-v-e6089bcd>`);
      });
      _push(`<!--]--></div></div></div>`);
    };
  }
...
const WebDesignCarousel = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e6089bcd"]]);
const _sfc_main = {
  __name: "WebDesign",
  __ssrInlineRender: true,
  props: {
