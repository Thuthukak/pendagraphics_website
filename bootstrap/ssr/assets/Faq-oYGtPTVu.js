import { ref, computed, mergeProps, useSSRContext, resolveComponent, withCtx, createVNode, resolveDynamicComponent, createTextVNode, toDisplayString, createBlock, openBlock } from "vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrRenderVNode } from "vue/server-renderer";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Head, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title data-v-b207b864${_scopeId}>${ssrInterpolate(__props.seo.title)}</title>`);
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent("script"), { type: "application/ld+json" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(__props.structuredData)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(__props.structuredData), 1)
                  ];
                }
              }),
              _: 1
            }), _parent2, _scopeId);
            _push2(`<meta name="description"${ssrRenderAttr("content", __props.seo.description)} data-v-b207b864${_scopeId}><meta name="keywords"${ssrRenderAttr("content", __props.seo.keywords)} data-v-b207b864${_scopeId}><meta name="author" content="Penda Graphics" data-v-b207b864${_scopeId}><meta name="viewport" content="width=device-width, initial-scale=1.0" data-v-b207b864${_scopeId}><link rel="canonical"${ssrRenderAttr("href", __props.seo.canonical_url)} data-v-b207b864${_scopeId}><meta property="og:title"${ssrRenderAttr("content", __props.seo.og_title)} data-v-b207b864${_scopeId}><meta property="og:description"${ssrRenderAttr("content", __props.seo.og_description)} data-v-b207b864${_scopeId}><meta property="og:image"${ssrRenderAttr("content", __props.seo.og_image)} data-v-b207b864${_scopeId}><meta property="og:url"${ssrRenderAttr("content", __props.seo.og_url)} data-v-b207b864${_scopeId}><meta property="og:type"${ssrRenderAttr("content", __props.seo.og_type)} data-v-b207b864${_scopeId}><meta property="og:site_name"${ssrRenderAttr("content", __props.seo.og_site_name)} data-v-b207b864${_scopeId}><meta name="twitter:card"${ssrRenderAttr("content", __props.seo.twitter_card)} data-v-b207b864${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", __props.seo.og_title)} data-v-b207b864${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", __props.seo.og_description)} data-v-b207b864${_scopeId}><meta name="twitter:image"${ssrRenderAttr("content", __props.seo.og_image)} data-v-b207b864${_scopeId}><meta name="robots" content="index, follow" data-v-b207b864${_scopeId}><meta name="googlebot" content="index, follow" data-v-b207b864${_scopeId}><meta name="language" content="en-US" data-v-b207b864${_scopeId}><meta name="geo.region" content="ZA" data-v-b207b864${_scopeId}><meta name="geo.country" content="South Africa" data-v-b207b864${_scopeId}><meta name="geo.placename" content="Johannesburg, Gauteng" data-v-b207b864${_scopeId}>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(Layout, { seo: __props.seo }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section id="apply" class="cta" data-v-b207b864${_scopeId}><div class="container" data-aos="zoom-in" data-v-b207b864${_scopeId}><div class="text-center text-white" data-v-b207b864${_scopeId}><h1 class="fw-bold" data-v-b207b864${_scopeId}>Frequently Asked Questions</h1><p class="mt-3 fs-5" data-v-b207b864${_scopeId}>Get answers to common questions about our web design, branding, and digital marketing services</p></div></div></section><section class="banner-image" data-v-b207b864${_scopeId}><div class="container mt-5 my-5 py-5 px-4" data-v-b207b864${_scopeId}><nav aria-label="breadcrumb" class="mb-4" data-v-b207b864${_scopeId}><ol class="breadcrumb" data-v-b207b864${_scopeId}><li class="breadcrumb-item" data-v-b207b864${_scopeId}><a href="/" data-v-b207b864${_scopeId}>Home</a></li><li class="breadcrumb-item active" aria-current="page" data-v-b207b864${_scopeId}>FAQ</li></ol></nav><div class="row justify-content-center mb-5" data-v-b207b864${_scopeId}><div class="col-lg-8" data-v-b207b864${_scopeId}><div class="text-center mb-4" data-v-b207b864${_scopeId}><h2 class="h3 mb-3" data-v-b207b864${_scopeId}>Common Questions About Our Design Services</h2><p class="text-muted" data-v-b207b864${_scopeId}> We&#39;ve compiled answers to the most frequently asked questions about our web design, graphic design, branding, e-commerce, and digital marketing services in South Africa. </p></div></div></div>`);
            _push2(ssrRenderComponent(FaqComponent, null, null, _parent2, _scopeId));
            _push2(`<div class="mb-5 mt-5 px-4" data-v-b207b864${_scopeId}><div class="row justify-content-center" data-v-b207b864${_scopeId}><div class="col-lg-8" data-v-b207b864${_scopeId}><div class="text-center bg-light rounded p-4" data-v-b207b864${_scopeId}><h3 class="h4 mb-3" data-v-b207b864${_scopeId}>Still Have Questions?</h3><p class="text-muted mb-3" data-v-b207b864${_scopeId}> If you can&#39;t find the answer you&#39;re looking for, our team is ready to help you with personalized advice. </p><div class="d-flex align-items-center gap-2 flex-wrap justify-content-center" data-v-b207b864${_scopeId}><h5 class="mb-0 fw-bold" data-v-b207b864${_scopeId}>Can&#39;t find what you&#39;re looking for?</h5><a href="/contact-us" class="btn btn-primary" data-v-b207b864${_scopeId}>Contact Us Today</a></div></div></div></div></div></div></section>`);
          } else {
            return [
              createVNode("section", {
                id: "apply",
...
const Faq = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b207b864"]]);
export {
  Faq as default
};
